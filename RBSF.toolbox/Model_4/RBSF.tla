...
Broadcast(msg, pid) ==  /\ /\ Debug("_____________________________________START............."\cup pid,2)
                      ...
                      /\ \A p \in processes :  rcQ'[p] = rcQ[p] \cup {[content |-> msg]} \*Send(p,[content |->  msg, sendId |-> pid])\*, seqNo |-> seqNoQ[pid]])           
                      /\ Debug("Broadcast Done"\cup rcQ' \cup rcQ',2)
...
myCallBackForRB(m) == Debug("Delivered by RB",2) /\ Debug(m, 2)                       
...
\* Last modified Wed Apr 23 09:24:43 EDT 2014 by Suvidha
